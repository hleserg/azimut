...
{Как мы убедимся, что решение реализовано правильно? Например: `docker compose --profile diagrams up -d structurizr` рендерит новые views; CI-линт проходит; тест в CI зелёный.}
