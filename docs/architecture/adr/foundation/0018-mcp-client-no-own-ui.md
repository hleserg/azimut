...
implemented-in: ""
related-to: "[0019](https://github.com/hleserg/azimut/blob/master/docs/architecture/adr/foundation/0019-cherry-studio-default-client.md)"
supersedes: ""
superseded-by: "0019"
---
...
> и немедленно уточнено в ADR [0019](https://github.com/hleserg/azimut/blob/master/docs/architecture/adr/foundation/0019-cherry-studio-default-client.md), который
...
**Уточнён в ADR [0019](https://github.com/hleserg/azimut/blob/master/docs/architecture/adr/foundation/0019-cherry-studio-default-client.md):** выбор конкретного
