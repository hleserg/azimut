...
related-to: "[0021](https://github.com/hleserg/azimut/blob/master/docs/architecture/adr/foundation/0021-default-model-deepseek-v4.md)"
supersedes: "0018"
superseded-by: ""
---
...
ADR [0018](https://github.com/hleserg/azimut/blob/master/docs/architecture/adr/foundation/0018-mcp-client-no-own-ui.md) зафиксировал принцип «готовый MCP-клиент, не
...
* Совместимость лицензии с AGPL-3.0 проекта (см. ADR [0023](https://github.com/hleserg/azimut/blob/master/docs/architecture/adr/foundation/0023-license-checklist-and-source-rule.md))
...
Дефолт-модель для Cherry Studio → ADR [0021](https://github.com/hleserg/azimut/blob/master/docs/architecture/adr/foundation/0021-default-model-deepseek-v4.md).
Лицензионная совместимость → ADR [0023](https://github.com/hleserg/azimut/blob/master/docs/architecture/adr/foundation/0023-license-checklist-and-source-rule.md).
